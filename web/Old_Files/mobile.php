  ...
  <body>
    ...
    <div id="menu" style="display:none;">
    	<ul>
    	  ...
    	  <li>Trains</li>
    	  <li style="border-bottom:none;border-bottom-left-radius:5px;border-bottom-right-radius:5px;">Trains</li>
    	</ul>
    </div>
    ...
    <div id="switches" style="display:block">
      <div class="drag"><b>Switches</b><img src="./img/enlarge.png" width="14px" style="margin:3px;float:right"/></div>
      <div class="box">
        <div class="content"></div>
      </div>
    </div>
