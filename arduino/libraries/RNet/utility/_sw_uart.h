...
#ifndef LN_SW_UART_SET_TX_HIGH                               // putting a 1 to the pin to switch on NPN transistor
#define LN_SW_UART_SET_TX_HIGH(LN_TX_PORT, LN_TX_BIT)  LN_TX_PORT |= (1 << LN_TX_BIT)   // to pull down LN line to drive low level
#endif

#ifndef LN_SW_UART_SET_TX_LOW                              // putting a 0 to the pin to switch off NPN transistor
