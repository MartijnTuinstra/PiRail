  ...
  <body>
    ...
    <div id="menu" style="display:none;">
    	<ul>
    	  ...
    	  <li>Manage blocks</li>
    	  <li onClick="if(tablet == 0){myWindow = window.open('./manage_trains.php', 'Manage trains', 'width=800,height=500');}else{window.location.href = './manage_trains.php?tablet=y'}">Manage trains</li>
    ...
    <div id="warning_list" class="warning_list_nactive">
      <div class="warning">
